...
# Compare performances between F test and the equivalence test (N = 100)

sink("log/log_sim_tests_n100.txt") # start log
begin.time<-Sys.time()
...
# f_size_seq <- c(seq(from = 0, to = 1, by = 0.1), 1.25, 1.5, 2)
n <- 100
